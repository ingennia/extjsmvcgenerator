class GisConfigGenerator < Rails::Generators::Base
  ...
  argument :postgis_path, :type => :string, :default => (ENV['POSTGRES']) ?  "#{ENV['POSTGRES']}/share/postgresql/contrib/postgis-1.5" : '/Library/PostgreSQL/9.1/share/postgresql/contrib/postgis-1.5'
